# Entrypoint for the Qwen3.6-27B backend on Windows (PowerShell).
#
# Make sure configs\qwen3_6_27b.yaml has the correct ``api.model``,
...
$ConfigFile = Join-Path $ProjectRoot "configs\qwen3_6_27b.yaml"
