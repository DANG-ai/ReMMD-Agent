# Entrypoint for the Qwen3.5-9B backend on Windows (PowerShell).
#
# Make sure configs\qwen3_5_9b.yaml has the correct ``api.model``,
...
$ConfigFile = Join-Path $ProjectRoot "configs\qwen3_5_9b.yaml"
